...
public class Menu_Controller : MonoBehaviour {
	...
	[Tooltip("defines the name who has the biggest highscore")]
	...
	void Awake () {
		...
		highScoreName.text = "High Score: " + DataManager.Instance.highscoreName;
	}
	
	public void PlayGame () {
		_audioSource.PlayOneShot(_audioClip);
		PlayerPrefs.SetString("_LastScene", scene.name);
		DataManager.Instance.currentName = input.text;
	...
	public void DeleteData() {
		DataManager.Instance.DeleteScore();
		highScoreName.text = "High Score: " + DataManager.Instance.highscoreName;
